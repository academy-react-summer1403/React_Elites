          ...
          {(form) => (
                  ...
                  <div className={`${styleLogin.navigate} ${styleLogin.navigateRegister}`}>
                      ...
                      <div className="h-full max-w-96 mx-0 text-right">
                        ...
                        <Field className="w-full text-right h-11 pr-3  mb-4 bg-white text-black border border-solid border-black-800 rounded-3xl text-black" name="verifyCode" placeholder="کد تایید خود را وارد کنید" />
