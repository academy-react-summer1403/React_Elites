  ...
  return (
    ...
    <div className={styleLogin.HomePageButtonHolder}>
      <NavLink to="/" className={styleLogin.HomePageButton}>
        <h1 data-theme={darkMode ? "darkNoBG" : "lightMode"} className="border-non  cursor-pointer text-blue-700 text-sm font-DannaBold tracking-tight"> {t("MainPage")} </h1>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path data-theme={darkMode ? "darkPath" : "lightMode"} d="M10 18H14" stroke="#3772FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
