                  ...
                  <Form className={styleLogin.form}>
                      <div className={styleLogin.navigate}>
                        <div className="w-1/2 flex flex-wrap h-full w-64 bg-blue">
                          ...
                          <h1 className="w-full align-right text-black text-sm font-semibold tracking-tight">وارد کردن ایمیل </h1>
                        </div>
                      ...
                      <div className="h-full max-w-96 my-8 mx-0">
                        <h1 className="text-black text-2xl font-bold m-4">فراموشی رمز عبور!</h1>
                        <p className="text-gray-400 text-sm font-semibold">اگر رمزعبور خود را فراموش کرده اید ایمیل خود را وارد کنید تا لینک صفحه تغییر رمز عبور برای شما ارسال شود</p>
                      </div>
                      <div className="h-full max-w-96  my-4 mx-0 text-right">
                        <label className="text-base font-bold text-black pb-1.5">ایمیل</label>
                      ...
                      <NavLink to="/Forget-Password-Page2" className="h-11 max-w-96 overflow-hidden flex">
                        <button  className="h-full w-full text-white bg-blue-600 text-lg leading-4 font-lg font-bold uppercase tracking-wider cursor-pointer rounded-full overflow-hidden" type="submit">ارسال لینک</button>
                      </NavLink>
