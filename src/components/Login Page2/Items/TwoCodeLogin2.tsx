...
const TwoCodeLogin2 = ({setverifyCode}) => {
  ...
  return (
    ...
    <div className={styleLogin.inputHolder}>
      ...
      <Field data-theme={darkMode ? "darkSmall" : "lightMode"} className={styleLogin.input} name="forgetPassPage2" placeholder="کد دو مرحله‌ای خود را وارد کنید" onChange={(e) => setverifyCode(e.target.value)} />
