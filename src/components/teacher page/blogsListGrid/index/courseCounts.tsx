...
const CourseCounts = (props) => {
  ...
  return (
    <div className={s.holderlinkedin}>
      ...
      <path d="M6 15H3" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div className={style.count} data-theme={darkMode ? "darkNoBG" : "lightMode"}> دوره ها : {props.count}</div>
    </div>
  )
}
