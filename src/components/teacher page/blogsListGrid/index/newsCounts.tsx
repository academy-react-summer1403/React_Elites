...
const NewsCounts = (props) => {
  ...
  return (
    <div className={s.holderlinkedin}>
      ...
      <path d="M6 17H6.00898" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M2 7H10" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div className={style.count} data-theme={identifier("darkNoBG","dark2NoBG")}> خبر ها : {props.countN}</div>
    </div>
  )
}
