...
const Comment = ({avatar, userName, date, title, description, likeCount, disLikeCount}) => {
  return (
    <div className={style.containerComment}>
        <div className={style.header}>
            ...
            <div className={style.column}>
                ...
                <div className={style.date}>{dateConvertor(date)}</div>
            </div>
            ...
            <div className={style.footer}>
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 11.5C2 12.6046 2.89543 13.5 4 13.5C5.65685 13.5 7 12.1569 7 10.5V6.5C7 4.84315 5.65685 3.5 4 3.5C2.89543 3.5 2 4.39543 2 5.5V11.5Z" stroke="#2F2F2F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
