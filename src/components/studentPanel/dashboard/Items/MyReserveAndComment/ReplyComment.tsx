...
const ReplyComment = ({title, pictureAddress, likeCount, disslikeCount, describe, author, insertDate}) => {
    ...
    return (
        <div data-theme={darkMode ? "dark" : "lightMode"} className={style.mainHolder}>
                ...
                <div className={style.header}>
                    ...
                    <img className={style.userAvatar} src={pictureAddress} />
                        <div className={style.holderUsername}>
                            <div data-theme={darkMode ? "darkNoBG" : "lightMode"} className={style.userName}> {author} </div>
                            <div data-theme={darkMode ? "darkNoBGDisc" : "lightMode"} className={style.insertDate}> {dateConvertor(insertDate)} </div>
                        </div>
                    </div>
                </div>
                <div className={style.content}>
                    <div data-theme={darkMode ? "darkNoBG" : "lightMode"} className={style.commentTitle}> {title} </div>
                    <div data-theme={darkMode ? "darkNoBG" : "lightMode"} className={style.commentDesc}> {describe} </div>
                </div>
                <div className={style.footer}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path data-theme={darkMode ? "darkPath" : "lightMode"}  d="M2 12.5C2 11.3954 2.89543 10.5 4 10.5C5.65685 10.5 7 11.8431 7 13.5V17.5C7 19.1569 5.65685 20.5 4 20.5C2.89543 20.5 2 19.6046 2 18.5V12.5Z" stroke="#2F2F2F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div data-theme={darkMode ? "darkNoBG" : "lightMode"} className={style.count}>{disslikeCount}</div>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path data-theme={darkMode ? "darkPath" : "lightMode"} d="M2 11.5C2 12.6046 2.89543 13.5 4 13.5C5.65685 13.5 7 12.1569 7 10.5V6.5C7 4.84315 5.65685 3.5 4 3.5C2.89543 3.5 2 4.39543 2 5.5V11.5Z" stroke="#2F2F2F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div data-theme={darkMode ? "darkNoBG" : "lightMode"} className={style.count}>{likeCount}</div>
            </div>
            </div>
        </div>
    )
