...
const ReplyComment = ({title, pictureAddress, likeCount, disslikeCount, describe, author, insertDate}) => {
    ...
    return (
        <div data-theme={identifier("dark","dark2","green","pink","blue","red")} className={style.mainHolder}>
            ...
            <div className={style.holder}>
                <div className={style.header}>
                    ...
                    <img className={style.userAvatar} src={pictureAddress} />
                        <div className={style.holderUsername}>
                            <div data-theme={identifier("darkNoBG","dark2NoBG","greenNoBG","pinkNoBG","blueNoBG","redNoBG")} className={style.userName}> {author} </div>
                            <div data-theme={identifier("darkNoBGDisc","dark2NoBGDisc","greenNoBGDisc","pinkNoBGDisc","blueNoBGDisc","redNoBGDisc")} className={style.insertDate}> {dateConvertor(insertDate)} </div>
                        </div>
                    </div>
                </div>
                <div className={style.content}>
                    <div data-theme={identifier("darkNoBG","dark2NoBG","greenNoBG","pinkNoBG","blueNoBG","redNoBG")} className={style.commentTitle}> {title} </div>
                    <div data-theme={identifier("darkNoBG","dark2NoBG","greenNoBG","pinkNoBG","blueNoBG","redNoBG")} className={style.commentDesc}> {describe} </div>
                </div>
                <div className={style.footer}>
                    ...
                    <div data-theme={identifier("darkNoBG","dark2NoBG","greenNoBG","pinkNoBG","blueNoBG","redNoBG")} className={style.count}>{disslikeCount}</div>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
