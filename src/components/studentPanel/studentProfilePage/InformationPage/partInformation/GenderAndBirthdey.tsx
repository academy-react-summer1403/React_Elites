        ...
        <>
            <div className={styleInform.genderAndBirthdey}>
                <div className={styleInform.smallDiv}>
                    <h1 data-theme={identifier("darkNoBG","dark2NoBG")}>{t("birthday")}</h1>
                    <Field name="birthDay" className={styleInform.Input} placeholder={t("enterBirthday")} data-theme={identifier("dark","dark2")} />
                </div>
                <div className={styleInform.smallDiv}>
                    <h1 data-theme={identifier("darkNoBG","dark2NoBG")}>{t("gender")}</h1>
                    <div className={styleInform.inputGender}>
                        <div>
                            ...
                            <h1 data-theme={identifier("darkNoBG","dark2NoBG")}> {t("man")}</h1>
                        </div>
                        <div>
                            <Field type="radio" id="womanInput" name="gender2" className={styleInform.GenderInput} onChange={() => {
                                setisMale(false)
                            }} />
                            <h1 data-theme={identifier("darkNoBG","dark2NoBG")}> {t("woman")}</h1>
                        </div>
                        <button onClick={() => {
                            if (isMale === true) {
