                ...
                <div className={style.bottom}>
                    <div className={style.menu}>
                        ...
                        <div>
                            ...
                            <NavLink to='/Student-Panel/Information' data-theme={identifier("darkNoBG","dark2NoBG")}> {t("Profile")}</NavLink>
                        </div>
                        <div>
                        ...
                        <div>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path data-theme={identifier("darkPath","dark2Path")} d="M14.5 13.5C14.5 14.8807 13.3807 16 12 16C10.6193 16 9.5 14.8807 9.5 13.5C9.5 12.1193 10.6193 11 12 11C13.3807 11 14.5 12.1193 14.5 13.5Z" stroke="#FCFCFC" stroke-width="1.5" />
                                <path data-theme={identifier("darkPath","dark2Path")} d="M5.5 14.5V14.509" stroke="#FCFCFC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path data-theme={identifier("darkPath","dark2Path")} d="M18.5 12.4922V12.5012" stroke="#FCFCFC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path data-theme={identifier("darkPath","dark2Path")} d="M9.5 4.5C9.99153 3.9943 11.2998 2 12 2M12 2C12.7002 2 14.0085 3.9943 14.5 4.5M12 2V8" stroke="#FCFCFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>

                            <NavLink to="/Student-Panel/Shopping-Basket" data-theme={identifier("darkNoBG","dark2NoBG")}> {t("Payments")}</NavLink>
                        </div>
                    </div>
