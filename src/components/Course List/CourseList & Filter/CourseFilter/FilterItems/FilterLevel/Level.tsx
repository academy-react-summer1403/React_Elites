  ...
  return (
    <>
          <div className={style.holderIconAndTitle}>
            ...
            <div className={style.titleLevel} data-theme={identifier("level","level2")}> {t("EducationalLevel")} </div>
          </div>
        <div className={style.level1} data-theme={identifier("dark","dark2")}>{t("levelCourses")}
